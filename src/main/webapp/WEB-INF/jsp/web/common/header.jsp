                        ...
                        <div class="menu-left">
                            <div class="sm-nav-block">
                                ...
                                <ul class="nav-slide">
                                    ...
                                    <li>
                                        <a href="#">mor category <i class="fa fa-angle-down"></i></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="nav-left">
                                    ...
                                    <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font m-0">
                                            <li> <img src="../assets/images/layout-1/nav-img/01.png" alt="category-banner"> <a>western ware</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/02.png" alt="category-banner"> <a>TV, Appliances</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/03.png" alt="category-banner"> <a>Pets Products</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/04.png" alt="category-banner"> <a>Car, Motorbike</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/05.png" alt="category-banner"> <a>Industrial Products</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/06.png" alt="category-banner"> <a>Beauty, Health Products</a></li>
                                            <li> <img src="../assets/images/layout-1/nav-img/07.png" alt="category-banner"> <a>Grocery Products </a></li>
